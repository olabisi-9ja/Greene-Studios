      ...
      <div className="mx-auto flex max-w-[1400px] flex-col gap-14 px-5 md:px-10 lg:flex-row lg:gap-24">
        ...
        <div className="self-start lg:sticky lg:top-32 lg:w-1/3">
          ...
          <div className="mt-10 hidden items-center gap-3 lg:flex">
            <span className="flex h-9 w-9 items-center justify-center rounded-full bg-[var(--brand-accent)] font-mono text-sm font-medium text-[var(--brand-on-accent)]">
              ✦
            </span>
          ...
          {condensed ? (
            <Link
              href="/process"
              data-cursor="GO"
              className="group mt-8 inline-flex items-center gap-3 rounded-full border border-[var(--brand-border)] px-5 py-3 text-[14px] font-medium text-[var(--brand-text)] transition-colors duration-300 hover:border-[var(--brand-text)] hover:bg-[var(--brand-text)] hover:text-[var(--brand-bg)]"
            >
